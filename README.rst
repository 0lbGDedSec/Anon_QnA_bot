...
To use bot you must have install `python-telegram-bot <https://github.com/python-telegram-bot/python-telegram-bot/wiki/Concurrency>`_ and Python 3.10 or newer.
...
Link for the official website: https://www.python.org/downloads/
